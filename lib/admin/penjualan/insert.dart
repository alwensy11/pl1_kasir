...
import 'package:pl1_kasir/admin/home.dart';  // Mengimpor widget MyHomePage untuk navigasi setelah transaksi

// Widget Stateful untuk SalesPage
class AdminSalesPage extends StatefulWidget {
  const AdminSalesPage({super.key});  // Konstruktor untuk SalesPage

  @override
  State<AdminSalesPage> createState() => _AdminSalesPageState();  // Membuat state untuk SalesPage
}
...
class _AdminSalesPageState extends State<AdminSalesPage> {
  ...
  Future<void> submitSale() async {
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => AdminMyHomePage()),  // Arahkan ke MyHomePage
    );
  }
