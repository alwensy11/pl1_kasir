...
import 'package:pl1_kasir/admin/home.dart'; // Mengimpor halaman Home.
...
class AdminAddProdukPage extends StatefulWidget {
  @override
  _AdminAddProdukPageState createState() => _AdminAddProdukPageState(); // Membuat State terkait.
}

// State dari AddProdukPage.
class _AdminAddProdukPageState extends State<AdminAddProdukPage> {
  ...
  Future<void> _addProduct() async {
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => AdminMyHomePage()),
    );
  }
