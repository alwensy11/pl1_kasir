...
class AdminEditPelangganPage extends StatefulWidget {
  ...
  @override
  __AdminEditPelangganPageState createState() => __AdminEditPelangganPageState();
}

class __AdminEditPelangganPageState extends State<AdminEditPelangganPage> {
