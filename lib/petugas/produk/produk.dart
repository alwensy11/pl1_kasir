...
import 'package:pl1_kasir/petugas/produk/insert.dart'; // Mengimpor halaman untuk menambahkan produk.
import 'package:pl1_kasir/petugas/produk/edit.dart'; // Mengimpor halaman untuk mengedit produk.
...
class ProdukPage extends StatefulWidget {
  const ProdukPage({super.key}); // Constructor dengan key opsional.

  @override
  State<ProdukPage> createState() => _ProdukPageState(); // Membuat state dari ProdukPage.
}
      ...
      floatingActionButton: Padding(
        ...
        child: ElevatedButton(
          onPressed: () async {
            final result = await Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => AddProdukPage()), // Navigasi ke halaman tambah produk.
            );
