...
import 'package:google_fonts/google_fonts.dart';  // Importing Google Fonts to use custom fonts// Import the UserPage widget
import 'package:pl1_kasir/petugas/produk/produk.dart';  // Import the ProdukPage widget
import 'package:pl1_kasir/petugas/pelanggan/pelanggan.dart';  // Import the PelangganPage widget
import 'package:pl1_kasir/petugas/penjualan/penjualan.dart';  // Import the PenjualanPage widget
import 'package:pl1_kasir/petugas/penjualan/detailpenjualan.dart';  // Import the DetailPenjualanPage widget
import 'package:pl1_kasir/petugas/user/user.dart'; 
  ...
  Widget build(BuildContext context) {
    return Scaffold(
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(builder: (context) => UserPage()),  // Navigate to the welcome screen on logout
                  );
                },
              ),
              // ListTile for the "Logout" option
      ...
      body: IndexedStack(
        ...
        children: const [
          ProdukPage(),  // First tab (Produk)
          PelangganPage(),  // Second tab (Pelanggan)
          PenjualanPage(),  // Third tab (Penjualan)
          DetailPenjualanPage(),  // Fourth tab (Detail Penjualan)
        ],
      ),
