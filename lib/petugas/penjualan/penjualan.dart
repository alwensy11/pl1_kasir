...
import 'package:pl1_kasir/petugas/penjualan/insert.dart'; // Mengimpor halaman untuk menambahkan data penjualan.
...
class PenjualanPage extends StatefulWidget {
  const PenjualanPage({super.key}); // Konstruktor default.

  @override
  State<PenjualanPage> createState() =>
      _PenjualanPageState(); // Membuat State terkait.
}
        ...
        child: ElevatedButton(
          onPressed: () async {
            ...
            final result = await Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (context) =>
                      SalesPage()), // Menuju halaman SalesPage.
            );
